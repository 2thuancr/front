...
const faqs = [
  {
    ...
    answer: 'Bạn có thể đặt hàng trực tuyến qua website, gọi điện thoại hoặc đến trực tiếp cửa hàng của chúng tôi.'
  },
  {
    question: 'Thời gian giao hàng là bao lâu?',
    answer: 'Thời gian giao hàng trong TP.HCM là 1-2 ngày, các tỉnh khác từ 3-7 ngày tùy thuộc vào địa điểm.'
  },
  {
    question: 'Có thể đổi trả sản phẩm không?',
    answer: 'Chúng tôi chấp nhận đổi trả trong vòng 7 ngày nếu sản phẩm còn nguyên vẹn và có hóa đơn mua hàng.'
  },
  {
    question: 'Có ship hàng quốc tế không?',
    answer: 'Hiện tại chúng tôi chỉ ship hàng trong nước. Chúng tôi đang phát triển dịch vụ ship quốc tế trong tương lai.'
  }
];
        ...
        <div className="relative container mx-auto px-4 text-center text-white">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Hãy để lại tin nhắn, chúng tôi sẽ liên hệ lại trong thời gian sớm nhất
            </p>
          </motion.div>
        </div>
      </div>
              ...
              <div className="p-6">
                ...
                <div className="w-full h-64 bg-gradient-to-br from-blue-400 to-purple-600 rounded-xl flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-sm opacity-80">1 Võ Văn Ngân, Linh Chiểu, Thủ Đức, TP.HCM</p>
                  </div>
                </div>
              </div>
            </Card>
